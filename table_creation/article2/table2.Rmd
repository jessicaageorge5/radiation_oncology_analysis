---
title: "Table 2 & Logistic Regression"
...
uni_predictors <- c("age_cat", "combined_cancer_stage", "eqd2", "total_chemo_received_4", "eqd2", "nrti", "pi", "cd4_final", "cd4_pos_cat2", "vl_final")


for (uni_predictor in uni_predictors) {
  for (response in responses) {
    print(c(response, uni_predictor))
    print("HIV Pos Overall")
    subset_univariate_logistic_regresion(response, uni_predictor, "HIV-infected")
  }
}
...
print("HIV-infected")
subset_univariate_logistic_regresion(response, predictor, "HIV-infected")
...
# Cr ~ chemo
# print(overall_univariate_logistic_regresion("cr_response", "total_chemo_received_4"))
...
Multivariate Logistic Regression for all patients
(Commented out -- Will modify after meeting with Shin and Zetola)
```{r}
...
# multi_predictors_v1 <- c("age_cat", "combined_cancer_stage",
#                     "hiv_status", "total_chemo_received_4", "eqd2")
# print(c("cr_response", multi_predictors_v1))
# print("Overall")
# print(overall_multivariate_logistic_regresion(response, multi_predictors_v1))

```

Multivariate Logistic Regression on HIV Pos
(Commented out-- Will modify after meeting with Shin and Zetola)
```{r}
# # HIV pos run
# # Hb and azt
