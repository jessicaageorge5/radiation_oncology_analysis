...
data %>%
  finalfit(dependent, all_multivariate_reduced5) %>%
  select("Dependent: Surv(time_alive_path, vital_status)", " ", "all", 
         "HR (multivariable)") %>% 
  knitr::kable()
