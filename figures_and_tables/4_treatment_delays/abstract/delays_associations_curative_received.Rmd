...
data <- original %>% filter((crt == "Yes" | rt == "Yes") & curative_palliative_status == "Curative")
```
...
# Multivariate Model
```{r}
multi_mod <- glm(path_treatment_90 ~ age_cat + distance_factored2 + hiv_status + final_combined_cancer_stage + pathology_group2, data=data, family=binomial())
