...
uni_predictors <- c("enroll_age", "age_cat", "marital", "distance_factored2", 
                    ...
                    "init_combined_cancer_stage", "init_combined_cancer_stage2", "init_combined_cancer_stage3",
                    "final_combined_cancer_stage", "final_combined_cancer_stage2", "final_combined_cancer_stage3",
                    ...
                    "hiv_cd4_cat2", "curative_palliative", "path_treatment_30", "path_treatment_60",
                    "path_treatment_90")
...
# Univariate Models
```{r echo=TRUE, message=FALSE, warning=FALSE}
tbl_uvregression(data=data[c(c("vital_status24"), uni_predictors)],
                 method = glm, 
                 y = vital_status24,
...
tbl_uvregression(data=data[c(c("vital_status24"), uni_predictors2)],
                 method = glm, 
                 y = vital_status24,
                 method.args=list(family=binomial),
