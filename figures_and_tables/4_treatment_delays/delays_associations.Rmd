---
title: "Table 2: Delays (90 days) Associations - Binomial Logistic Regression"
...
# Multivariate Model
```{r}
multi_mod <- glm(path_treatment_90 ~ age_cat + distance_factored2 + hiv_status + final_combined_cancer_stage2 + pathology_group2, data=data, family=binomial())
